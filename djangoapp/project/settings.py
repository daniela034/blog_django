...
# our static files will be on /data/web/static
# our media files will be on /data/web/media
...
SECRET_KEY = 'django-insecure-ts1qy8t&32c@d9mt4_2s+587g-k)o*=3#c_w-(8j0^+ambwfu#'
